...
The cool thing about the Conscious approach, which we used in building [the MLE classifier](link to other tab) is that we get to learn lots about how people draw things. Like, you can have a whole pizza, or you can have just a slice. Or most bananas dutifully obey the law of gravity, but some mischievous ones don't.
...
knitr::include_graphics("TrangPlots/model2_history.png")
```
...
knitr::include_graphics("TrangPlots/data_reduction_watermelon.png")
knitr::include_graphics("TrangPlots/data_reduction_sandwich.png")
knitr::include_graphics("TrangPlots/data_reduction_pear.png")
```
...
knitr::include_graphics("TrangPlots/rec_unrec_broccoli.png")
knitr::include_graphics("TrangPlots/rec_unrec_blackberry.png")
```
...
knitr::include_graphics("TrangPlots/cnn_vs_google.png")
```
...
knitr::include_graphics("TrangPlots/recognized_ordered.png")
```
...
knitr::include_graphics("TrangPlots/wrong_recognized_reordered.png")
```
...
knitr::include_graphics("TrangPlots/eight_pairs.png")
```
...
knitr::include_graphics("TrangPlots/unrecognized_ordered.png")
```
...
knitr::include_graphics("TrangPlots/wrong_unrecognized_reordered.png")
```
