...
3. **The rotation model with clusters.** 
We take whichever label from class one or two that produced a higher log likelihood.

4. **The combined model.** We take whichever label from class one or two that produced a higher log likelihood.
